...
import { MenuItems } from "@/src/shared/menuitems";
            ...
            <DropdownMenu className="m-2">
              <DropdownItem>
                <div className="space-y-2 mb-2 flex flex-col">
                  <Link
                    href="/profile"
                    className="bg-primary w-full rounded-lg text-white text-md p-2"
                  >
                    Profile
                  </Link>
                  <Link
                ...
                <Button
                  className="bg-secondary py-2 w-full h-auto text-white"
