...
import { useMakePostMutation } from "@/src/redux/features/post/postApi";
...
import { postValidation } from "@/src/validationSchema/validationSchema";
  ...
  return (
    <>
      ...
      <Modal
        ...
        className="bg-red-500 p-0 max-w-[900px] overflow-scroll max-h-[750px]"
      >
