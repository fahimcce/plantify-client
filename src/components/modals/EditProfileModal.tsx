...
import { uploadImageToCloudinary } from "@/src/utils/uploadImageCloudinary";
...
export default function EditUser() {
  ...
  const socilaLinksValue = dataUser?.links?.map(
  ...
  return (
    <div className="flex-1">
      <Button
        onPress={onOpen}
        className="absolute bg-secondary text-white right-0 top-4"
      >
        Edit? <FaEdit size={15} />
      </Button>
              ...
              <ModalBody>
                <GFrom onSubmit={handleEditUser}>
                  ...
                  <Button
                    type="submit"
                    onPress={onClose}
                    className="mt-4 md:w-[300px] mx-auto bg-secondary text-white"
                  >
                    Update
                  </Button>
                </GFrom>
